...
print("Error we are getting is Value of optional type 'Int?' must be unwrapped to a value of type \'Int\'")
...
print(userAge);
print("The value will return nil because 34e isn't an integer, hence it's not stored in the variable")
...
if let optionalUserAge = userAge {
    print(optionalUserAge)
} else {
    print("nil")
}
